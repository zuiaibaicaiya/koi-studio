...
// UserUpdateRequest 更新用户请求（字段均为可选，仅更新传入项）
...
func (r *UserUpdateRequest) Filters(ctx http.Context) map[string]any {
...
func (r *UserUpdateRequest) Rules(ctx http.Context) map[string]any {
	return map[string]any{
		"username": "min_len:6|max_len:255",
		"password": "min_len:6|max_len:255",
		"nickname": "max_len:50",
		"email":    "email",
